// Generated by SolidPython 1.1.3 on 2025-03-24 17:59:58
$fa = 0.4; $fs = 0.4;
...
rotate(a = 0, v = [1, 0, 0]) {
	difference() {
			...
			difference() {
				linear_extrude(height = 1.4500000000) {
					offset(r = 1.0000000000) {
						import(file = "C:/Users/phili/Documents/GitHub/thesis/boards/test_hard/test_hard-EdgeCuts.dxf", origin = [0, 0]);
					}
				}
		...
		linear_extrude(center = true, height = 0.6000000000) {
			translate(v = [0, 0, 0]) {
				import(file = "C:/Users/phili/Documents/GitHub/thesis/boards/test_hard/test_hard-PasteBottom.dxf", origin = [0, 0]);
			}
		}
	}
}
